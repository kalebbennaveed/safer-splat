...
class CBF_SINGLE():
    def __init__(self, gsplat, dynamics, alpha, radius, distance_type=None):
        ...
        if minimal:
            ...
            try:
                try:
                    ...
                    feasible_pt = - x[..., :3].cpu().numpy()
                    # print("feasible_pt", feasible_pt)
